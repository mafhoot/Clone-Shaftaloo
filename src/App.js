...
import FormEdit from "./Components/prof/formEdit";
import ProfileCard from "./Components/prof/ProfileCard";
    ...
    <div className="AllAll">
      ...
      <Routes>
        ...
        <Route path='/' element={<AppLayout />}>
          ...
          <Route path='/profile/edit' element={<FormEdit/>} />
          <Route path='/profile' element={<ProfileCard/>} />
          <Route path='/restaurnt' element={<Restaurant_page />} />
        </Route>
      </Routes>
      </BrowserRouter>
    </div>
