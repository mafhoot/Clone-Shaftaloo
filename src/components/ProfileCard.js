...
// file.preview = getBase64(file.originFileObj);
	return (
		<div className="card-container-000">
			<div className="ddd">
			    {/* <div className="profileCover"> */}
						...
						{/* <div className='profile_img text-center p-4'>
							<div className='flex flex-column '> */}
							           {/* <div className="profileCover"> */}
											<img className='iiio' src={avatar} alt={props.name} />
				...
				<h1 className="bold-text">
					{props.name} <span className="normal-text-op">{props.age}</span>
				</h1>
					...
					<h2 className="normal-text-op">{props.city}</h2>
