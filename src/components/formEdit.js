...
const [formvalue, setFormvalue] = useState("fgsfdfg")


const handleOnchange = (e) => {
	console.log("dfdfdfdf" , e?.target?.value);
...
<div className="background-87">
    <div className="bg-pattern-top"></div>
     	<div className="card-cont-1234567">
			<div>
			{/* <div className="auth-form-container"> */}
				<h3 className="as">Update Information</h3>
			{/* </div>		 */}
				<form className="register-form-2222" onSubmit={handleSubmit}>
					<label htmlFor="name">Username</label>
					<input className="ttt12" value={name} required onChange={(e) => setName(e.target.value)} name="name" id="name" placeholder="Your Username" />
					<label htmlFor="name">Phone</label>
					<input className="ttt12" value={name2} required onChange={(e) => setName2(e.target.value)} name="name" id="name" placeholder="Your PhoneNumber" />
					<label htmlFor="email">E-Mail</label>
					<input className="ttt12" value={email} required onChange={(e) => setEmail(e.target.value)}type="email" placeholder="Example@gmail.com" id="email" name="email" />
					<span className="registerError">{emailcheck}</span>
					<label htmlFor="password">New Password</label>
					<input className="ttt12" value={pass} required onChange={(e) => setPass(e.target.value)} type="password" placeholder="********" id="password" name="password" />
					<span className="registerError">{passcheck}</span>
					<label htmlFor="password2">Re-type New Password</label>
					<input className="ttt12" value={pass2} required onChange={(e) => setPass2(e.target.value)} type="password" placeholder="********" id="password2" name="password2" />
