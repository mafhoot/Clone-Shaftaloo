...
export default function EditableUserProfile({
    ...
    const [Family, setFamily] = useState(stored.Family);
    ...
    function handleSaveClicked() {
        console.log("Saved");
        editCompleteCallback({name, month, day, color,Family});
    }
    ...
    return <>
        ...
        <Group>
            ...
            <button style={buttonStyle} onClick={handleCancelClicked}>Edit</button>
